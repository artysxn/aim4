...
// rules — random speed per dot, 0.15–0.35 s continuous hold (smaller/faster →
// shorter), kill, 0.5 s respawn. The canvas is an elliptical board sized exactly to the
// dot's travel path.
// ---------------------------------------------------------------------------
