...
const GAME_FALLBACK_SKIP = /^\/(api|ws|football|training|leaderboards|replays|tools|assets|fonts|maps|map-practice|src|public|node_modules|@|demos|playlists|database|charts|patterns|uploads|routines|replay-viewer|team|account|admin|i|s2|icons)(\/|$)/;
