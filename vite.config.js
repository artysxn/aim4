...
const GAME_FALLBACK_SKIP = /^\/(api|ws|football|training|leaderboards|replays|tools|assets|fonts|maps|src|public|node_modules|@|demos|playlists|database|charts|patterns|uploads|routines|replay-viewer|icons)(\/|$)/;
