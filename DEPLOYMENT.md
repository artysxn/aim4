...
| `AIM4_REPLAY_DIR` | Server | `server/data/replays` | Demo library + round notes + Position Editor data (`zones/`). Needs a persistent disk. |
| `AIM4_ZONES_DIR` | Server | `{AIM4_REPLAY_DIR}/zones` | Optional override for Position Editor JSON. |
